...
export default function ControladorLista({ clientes, onAddCliente, onUpdateCliente }) {
  ...
  return (
    <div>
      ...
      <ListaClientes clientes={clientesPaginados} onAddCliente={onAddCliente} onUpdateCliente= {onUpdateCliente}/>
